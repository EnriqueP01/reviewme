    ...
    <div class="max-w-[1400px] mx-auto px-12">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            ...
            <div class="space-y-6">
                ...
                <ul class="space-y-4">
                    <li><a href="#" class="text-xs font-bold text-on-surface-variant hover:text-white transition-colors flex items-center gap-2 group"><span class="w-1 h-1 rounded-full bg-white/10 group-hover:bg-secondary transition-colors"></span> {{ __('Documentation') }}</a></li>
                    <li><a href="#" class="text-xs font-bold text-on-surface-variant hover:text-white transition-colors flex items-center gap-2 group"><span class="w-1 h-1 rounded-full bg-white/10 group-hover:bg-secondary transition-colors"></span> {{ __('API Status') }}</a></li>
                    <li><a href="#" class="text-xs font-bold text-on-surface-variant hover:text-white transition-colors flex items-center gap-2 group"><span class="w-1 h-1 rounded-full bg-white/10 group-hover:bg-secondary transition-colors"></span> {{ __('Changelog') }}</a></li>
                </ul>
            </div>
        ...
        <div class="pt-12 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-8">
            ...
            <div class="flex items-center gap-8">
                ...
                <a href="#" class="text-[9px] font-black uppercase tracking-widest text-on-surface-variant/40 hover:text-white transition-colors">{{ __('Terms') }}</a>
