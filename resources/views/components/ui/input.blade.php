@props(['disabled' => false, 'type' => 'text', 'placeholder' => '', 'label' => ''])

@php
    $inputClasses = 'bg-[#1a1b26] border border-white/5 text-on-surface placeholder:text-on-surface-variant/20 focus:border-primary/60 focus:ring-0 rounded-2xl transition-all duration-300 w-full px-4 py-3 group-hover:bg-[#1e1f2b] font-medium tracking-tight selection:bg-primary/20 shadow-inner';
@endphp
