                ...
                <div class="space-y-4">
                    ...
                    <div class="rounded-2xl bg-black/40 border border-white/5 p-6 font-mono text-xs text-secondary/80 leading-relaxed overflow-hidden relative group">
                        <div class="absolute top-4 right-4 opacity-0 group-hover:opacity-100 transition-opacity">
                            <button class="p-2 hover:bg-white/5 rounded-lg transition-all" title="{{ __('Copy') }}">
                        ...
                        <p><span class="text-primary/60">#</span> {{ __('Clone the elite stack') }}</p>
                        <p>git clone https://github.com/EnriqueP01/reviewme.git</p>
                        <p class="mt-2"><span class="text-primary/60">#</span> {{ __('Ignite the engine') }}</p>
