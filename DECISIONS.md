...
- **Statut** : ✅ Implémenté
- **Décision** :
    1. **Drop Gaps** : Insertion de zones de drop réactives avec feedback visuel "Ghosting".
    2. **Moteur Auto-Scroll** : Implémentation d'un algorithme de défilement adaptatif pendant le drag.
- **Impact** : Tri millimétré même sur de longues listes.
...
- **Auteur** : Antigravity
- **Statut** : ✅ Implémenté
- **Contexte** : Présence de bordures blanches intrusives et besoin d'une animation dynamique sur les titres.
- **Décision** :
    1. **Animation Reveal** : Header dynamique coulissant au survol.
    2. **Cleanup Visual** : Suppression des bordures blanches et alignement vertical strict du code.
- **Impact** : Interface plus aérée et hiérarchie de lecture optimisée.
